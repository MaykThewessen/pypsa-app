...
# Kept local to this schema (rather than utils/allowlists.py) since the
# analysis pipeline names are defined in services/analysis.py's ANALYSIS_TYPES
# dispatch table. Consider consolidating into utils/allowlists.py alongside
# ALLOWED_STATISTICS / ALLOWED_CHART_TYPES for consistency.
ALLOWED_ANALYSIS_TYPES: frozenset[str] = frozenset(
    {
        "dispatch_area",
